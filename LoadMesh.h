...
struct SubmeshData
{
   ...
   SubmeshData::SubmeshData() : mNumIndices(0), mBaseIndex(0), mBaseVertex(0) {}
   void DrawSubmesh();
};
...
struct MeshData
{
   ...
   MeshData::MeshData() : mVao(-1), mVboVerts(-1), mVboNormals(-1), mVboTexCoords(-1), mIndexBuffer(-1), mScaleFactor(0.0f), mScene(NULL) {}
